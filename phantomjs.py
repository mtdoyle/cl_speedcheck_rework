...
def test3(address, emm_stuff):
    ...
    browser.get('http://www.centurylink.com/home')
    time.sleep(1)
    # browser.find_element_by_id('home-internet-speed-check').click()
    ...
    while tries < 20:
        try:
            ...
            tries += 1
            if tries == 20:
                print "Tried 20 times to find link for {0}".format(address)
                return
